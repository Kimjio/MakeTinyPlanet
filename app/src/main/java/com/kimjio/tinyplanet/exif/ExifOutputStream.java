 ...
 *
 * <p>Below is an example of writing EXIF data into a file
 *
 * <pre>
...
class ExifOutputStream extends FilterOutputStream {
    ...
    /**
     * Writes the image out. The input data should be a valid JPEG format. After writing, it's Exif
     * header will be replaced by the given header.
     */
    @Override
    ...
    private void createRequiredIfdAndTag() throws IOException {
        ...
        if (exifOffsetTag == null) {
            throw new IOException(
                    "No definition for crucial exif tag: " + ExifInterface.TAG_EXIF_IFD);
        }
        ...
        if (gpsIfd != null) {
            ...
            if (gpsOffsetTag == null) {
                throw new IOException(
                        "No definition for crucial exif tag: " + ExifInterface.TAG_GPS_IFD);
            }
        ...
        if (mExifData.hasCompressedThumbnail()) {
            ...
            if (offsetTag == null) {
                throw new IOException(
                        "No definition for crucial exif tag: " + ExifInterface.TAG_STRIP_OFFSETS);
            }
            ExifTag lengthTag =
