...
public class ExifTag {
    ...
    /**
     * Sets integer value into this tag. This method should be used for tags of type {@link
     * #TYPE_UNSIGNED_SHORT}, or {@link #TYPE_LONG}. This method will fail if:
     *
     * <ul>
     *   <li>The component type of this tag is not {@link #TYPE_UNSIGNED_SHORT}, {@link
     *       #TYPE_UNSIGNED_LONG}, or {@link #TYPE_LONG}.
     *   <li>The value overflows.
     *   <li>The component count in the definition of this tag is not 1.
     * </ul>
     */
    public boolean setValue(int value) {
     ...
     *   <li>The component type of this tag is not {@link #TYPE_UNSIGNED_LONG}.
     *   <li>The value overflows.
     *   <li>The component count in the definition for this tag is not 1.
     * </ul>
     */
    public boolean setValue(long value) {
     ...
     * are replaced with '?'. The length of the string must be equal to either (component count -1)
     * or (component count). The final byte will be set to the string null terminator '\0',
     * overwriting the last character in the string if the value.length is equal to the component
     * count. This method will fail if:
     *
     * <ul>
     *   <li>The data type is not {@link #TYPE_ASCII} or {@link #TYPE_UNDEFINED}.
     *   <li>The length of the string is not equal to (component count -1) or (component count) in
    ...
    /**
     * Sets a Rational value into this tag. This method should be used for tags of type {@link
     * #TYPE_UNSIGNED_RATIONAL}, or {@link #TYPE_RATIONAL}. This method will fail if:
     *
     * <ul>
     *   <li>The component type of this tag is not {@link #TYPE_UNSIGNED_RATIONAL} or {@link
    ...
    /**
     * Sets byte value into this tag. This method should be used for tags of type {@link
     * #TYPE_UNSIGNED_BYTE} or {@link #TYPE_UNDEFINED}. This method will fail if:
     *
     * <ul>
     *   <li>The component type of this tag is not {@link #TYPE_UNSIGNED_BYTE} or {@link
     ...
     *
     * <ul>
     *   <li>The corresponding setValue method for the class of the object passed in would fail.
     *   <li>There is no obvious way to cast the object passed in into an EXIF tag type.
     * </ul>
     */
    ...
    /**
     * Gets the value as a byte array. This method should be used for tags of type {@link
     * #TYPE_UNDEFINED} or {@link #TYPE_UNSIGNED_BYTE}.
     *
     ...
     * This method should be used for tags of type {@link #TYPE_UNDEFINED} or {@link
     * #TYPE_UNSIGNED_BYTE}.
     *
    ...
    /**
     * Gets the value as an array of Rationals. This method should be used for tags of type {@link
     * #TYPE_RATIONAL} or {@link #TYPE_UNSIGNED_RATIONAL}.
     *
     ...
     * first one. This method should be used for tags of type {@link #TYPE_RATIONAL} or {@link
     ...
     * This method should be used for tags of type {@link #TYPE_UNSIGNED_SHORT}, {@link
     * #TYPE_UNSIGNED_LONG}.
     *
    ...
    /**
     * Gets the value as an array of longs. This method should be used for tags of type {@link
     * #TYPE_UNSIGNED_LONG}.
     *
     ...
     *
     * @exception IllegalArgumentException If the type is NOT {@link #TYPE_RATIONAL} or {@link
     *     #TYPE_UNSIGNED_RATIONAL}.
     */
    protected Rational getRational(int index) {
        if ((mDataType != TYPE_RATIONAL) && (mDataType != TYPE_UNSIGNED_RATIONAL)) {
            throw new IllegalArgumentException(
                    "Cannot get RATIONAL value from " + convertTypeToString(mDataType));
        }
     ...
     * @exception IllegalArgumentException If the type is NOT {@link #TYPE_UNDEFINED} or {@link
     *     #TYPE_UNSIGNED_BYTE}.
     */
    protected void getBytes(byte[] buf, int offset, int length) {
        if ((mDataType != TYPE_UNDEFINED) && (mDataType != TYPE_UNSIGNED_BYTE)) {
            throw new IllegalArgumentException(
                    "Cannot get BYTE value from " + convertTypeToString(mDataType));
        }
        System.arraycopy(
                mValue,
                0,
